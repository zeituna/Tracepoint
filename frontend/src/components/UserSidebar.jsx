  ...
  const menuSections = [
    {
      ...
      icon: Briefcase,
      items: [
        { path: '/reports', label: 'All Cases', icon: FileText },
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/settings?tab=security', label: 'Security', icon: Shield },
        ...
        <ul className="space-y-2">
          <li>
            ...
            >
              <LayoutDashboard
                size={20}
                className={isActive('/dashboard') ? 'text-emerald-600' : 'text-gray-400'}
              />
