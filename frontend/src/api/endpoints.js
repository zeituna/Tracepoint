...
cd ~/Tracepoint/frontend
cat > src/pages/Alerts.jsx << 'EOF'
...
EOFexport const API_ENDPOINTS = {
  ...
  REPORTS: {
    ...
    DETAIL: (id) => `${API_BASE_URL}/cases/${id}`,
    STATUS: (id) => `${API_BASE_URL}/cases/${id}/status`,
    COMMENT: (id) => `${API_BASE_URL}/cases/${id}/comments`,
    SEARCH: `${API_BASE_URL}/cases/search`,
  },
  TRACKING: {
    BASE: `${API_BASE_URL}/tracking`,
    LOCATION: (id) => `${API_BASE_URL}/tracking/${id}`,
    HISTORY: (id) => `${API_BASE_URL}/tracking/${id}/history`,
  },
  FACIAL: {
    UPLOAD: `${API_BASE_URL}/facial/upload`,
    MATCH: `${API_BASE_URL}/facial/match`,
    GALLERY: `${API_BASE_URL}/facial/gallery`,
    DELETE: (id) => `${API_BASE_URL}/facial/${id}`,
  },
  MESSAGES: {
  ...
  ALERTS: {
    ...
    DETAIL: (id) => `${API_BASE_URL}/alerts/${id}`,
    READ: (id) => `${API_BASE_URL}/alerts/${id}/read`,
    READ_ALL: `${API_BASE_URL}/alerts/read-all`,
  },
  USERS: {
  ...
  ORGANIZATIONS: {
    ...
    DETAIL: (id) => `${API_BASE_URL}/organizations/${id}`,
    MEMBERS: (id) => `${API_BASE_URL}/organizations/${id}/members`,
  },
  CASES: {
    BASE: `${API_BASE_URL}/cases`,
    DETAIL: (id) => `${API_BASE_URL}/cases/${id}`,
    STATUS: (id) => `${API_BASE_URL}/cases/${id}/status`,
    TIMELINE: (id) => `${API_BASE_URL}/cases/${id}/timeline`,
  },
  STATISTICS: {
    DASHBOARD: `${API_BASE_URL}/statistics/dashboard`,
    REPORTS: `${API_BASE_URL}/statistics/reports`,
    CASES: `${API_BASE_URL}/statistics/cases`,
